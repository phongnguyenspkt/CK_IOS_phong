...
class PeopleV: UIViewController {
    ...
    //khởi tạo dữ liệu
    var mcauHoi:[String] = [ "father"," mother"," uncle"," sister"," brother"," chore"]
    var mtraLoi:[String] = ["con trai","cha","mẹ","Chú","em gái","em trai","công việc nhà","dì ghẻ"]
  ...
  func doinen()
  {
    var hinh:UIImage=UIImage(named: "play.jpg")!
