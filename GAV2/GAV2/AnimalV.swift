...
class AnimalV: UIViewController {
    ...
    //khởi tạo dữ liệu
    var mcauHoi:[String] = [  "dog"," spider"," pig"," fish"," lion"," leopard"]
    var mtraLoi:[String] = [ "nai","chó"," con nhện"," con lợn"," cá"," sư tử"," con báo","gấu trúc"]
